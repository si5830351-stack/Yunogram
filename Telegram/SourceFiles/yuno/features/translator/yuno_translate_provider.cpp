...
#include "yuno/features/translator/yuno_translate_provider.h"

#include "api/api_text_entities.h"
#include "yuno/features/translator/yuno_translator.h"
...
class YunoTranslateProvider final
	: public Ui::TranslateProvider
	, public base::has_weak_ptr {
public:
	YunoTranslateProvider(
		not_null<Main::Session*> session,
		TranslationProvider provider)
	: _session(session)
	, _provider(provider) {
		if (!Yuno::Translator::TranslateManager::currentInstance()) {
	...
	void requestBatch(
		...
		const auto manager = Yuno::Translator::TranslateManager::currentInstance();
...
std::unique_ptr<TranslateProvider> CreateYunoTranslateProvider(
		not_null<Main::Session*> session,
		TranslationProvider provider) {
	return std::make_unique<YunoTranslateProvider>(session, provider);
}
