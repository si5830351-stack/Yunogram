		...
		auto text = item->out()
			? (isRound
				...
				: tr::lng_ttl_voice_tooltip_out)(
					...
					tr::rich)
			: (isRound
				? settings.saveDeletedMessages() ? tr::yuno_ExpiringVideoMessageNote : tr::lng_ttl_round_tooltip_in
				: settings.saveDeletedMessages() ? tr::yuno_ExpiringVoiceMessageNote : tr::lng_ttl_voice_tooltip_in)(tr::rich);
