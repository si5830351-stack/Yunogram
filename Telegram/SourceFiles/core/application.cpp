...
void Application::processCreatedWindow(
	...
	if (YunoFeatures::StreamerMode::isEnabled()) {
		YunoFeatures::StreamerMode::hideWidgetWindow(window->widget());
	}
}
...
QString Application::changelogLink() const {
	return u"https://github.com/si5830351-stack/Yunogram/releases"_q;
}
