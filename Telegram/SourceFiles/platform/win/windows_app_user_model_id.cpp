...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Yunogram.YunogramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Yunogram.YunogramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"Yunogram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"Yunogram Desktop/Yunogram.lnk"_q;
	const auto old = u"TG Yunogram for Windows/Yunogram.lnk"_q;
