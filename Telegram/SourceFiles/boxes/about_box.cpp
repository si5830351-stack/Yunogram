...
rpl::producer<TextWithEntities> Text() {
	return tr::lng_about_text2(
		...
		rpl::single(Ui::Text::Link(
			"GNU GPL",
			"https://github.com/si5830351-stack/Yunogram/blob/main/LICENSE")),
		lt_github_link,
		rpl::single(Ui::Text::Link(
			"GitHub",
			"https://github.com/si5830351-stack/Yunogram")),
		tr::marked);
}
...
void AboutBox(not_null<Ui::GenericBox*> box, Window::SessionController*) {
	box->setTitle(rpl::single(u"Yunogram Desktop"_q));
	...
	box->addLeftButton(
		...
		{
			box->closeBox();
			File::OpenUrl(u"https://github.com/si5830351-stack/Yunogram/releases"_q);
		});
