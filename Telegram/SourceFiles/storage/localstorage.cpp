...
#ifndef YUNOGRAM_UPDATE_PREFIX
#define YUNOGRAM_UPDATE_PREFIX ""
#endif
...
const QString &readAutoupdatePrefixRaw() {
	...
	return AutoupdatePrefix(QString::fromUtf8(YUNOGRAM_UPDATE_PREFIX));
}
...
void writeAutoupdatePrefix(const QString &prefix) {
	...
	const auto fixedPrefix = QString::fromUtf8(YUNOGRAM_UPDATE_PREFIX);
