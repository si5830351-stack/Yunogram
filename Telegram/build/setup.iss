...
WizardStyle=modern
    ...
    #define MyOutputBaseFilename "yunogramsetup-arm64." + MyAppVersionFull
  #elif MyBuildTarget == "win64"
    #define MyOutputBaseFilename "yunogramsetup-x64." + MyAppVersionFull
  #else
    #define MyOutputBaseFilename "yunogramsetup." + MyAppVersionFull
  #endif
#endif
